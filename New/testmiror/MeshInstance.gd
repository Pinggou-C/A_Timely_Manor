...
func update_cams(main_cam_transform):
	scale.y *= -1
...
#		print(N.name)
#==========================================================================================================================================================================================================================================================
		if((N.is_class("MeshInstance"))&&(!a.has(N))&&(!N.is_in_group("floor"))):		#it checks if a MeshInstance it finds in the entering body is not yet added in the dictionary
#For Diagnostics:==========================================================================================================================================================================================================================================
